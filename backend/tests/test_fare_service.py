...
def test_calculate_fare_medium_distance():
    ...
    G.add_edge("B", "C", distance=2.0, type="travel") # Total 5.0
...
def test_calculate_fare_with_interchange():
    ...
    G.add_edge("C", "D", distance=5.0, type="travel") # Total 11.0, Fare should be 32 (12 or less)
...
def test_calculate_fare_higher_brackets():
    ...
    assert FareService.calculate_fare(["A", "B"], G) == 43 # <= 21

    G.add_edge("B", "C", distance=10.0, type="travel") # Total 25.0
    assert FareService.calculate_fare(["A", "B", "C"], G) == 54 # <= 32

    G.add_edge("C", "D", distance=10.0, type="travel") # Total 35.0
    assert FareService.calculate_fare(["A", "B", "C", "D"], G) == 64 # > 32
